...
namespace Mirage.Analyzers.Tests
{
    ...
    public class Mirage1201Tests
    {
        ...
        {
            var code = VerifyCS.LoadTestData("Mirage1201Tests/Valid_StructTypeDoesNotReportWarning.cs");
        ...
        {
            var code = VerifyCS.LoadTestData("Mirage1201Tests/Invalid_ClassTypeReportsWarning.cs");
        ...
        {
            var code = VerifyCS.LoadTestData("Mirage1201Tests/Valid_WeaverSafeClassSuppressed.cs");
            await VerifyCS.VerifyAnalyzerAsync(code);
        }
        ...
        {
            var code = VerifyCS.LoadTestData("Mirage1201Tests/Valid_UnityTypesAllowed.cs");
