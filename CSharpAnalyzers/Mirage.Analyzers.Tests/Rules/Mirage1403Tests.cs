...
namespace Mirage.Analyzers.Tests
{
    ...
    public class Mirage1403Tests
    {
        ...
        {
            var code = VerifyCS.LoadTestData("Mirage1403Tests/Valid_CheckingActiveOrIsSpawnedDoesNotReportWarning.cs");
        ...
        {
            var code = VerifyCS.LoadTestData("Mirage1403Tests/Invalid_CheckingEnabledReportsWarning.cs");
