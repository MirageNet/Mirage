...
namespace Mirage.Analyzers.Tests
{
    ...
    public class Mirage1101Tests
    {
        ...
        {
            var code = VerifyCS.LoadTestData("Mirage1101Tests/Invalid_SyncVarOnNonNetworkBehaviour.cs");
        ...
        {
            var code = VerifyCS.LoadTestData("Mirage1101Tests/Invalid_ServerOnNonNetworkBehaviour.cs");
            var expected = VerifyCS.Diagnostic("MIRAGE1101")
                .WithLocation(0)
        ...
        {
            var code = VerifyCS.LoadTestData("Mirage1101Tests/Invalid_ClientOnNonNetworkBehaviour.cs");
            var expected = VerifyCS.Diagnostic("MIRAGE1101")
                .WithLocation(0)
        ...
        {
            var code = VerifyCS.LoadTestData("Mirage1101Tests/Invalid_ServerRpcOnNonNetworkBehaviour.cs");
            var expected = VerifyCS.Diagnostic("MIRAGE1101")
                .WithLocation(0)
        ...
        {
            var code = VerifyCS.LoadTestData("Mirage1101Tests/Invalid_ClientRpcOnNonNetworkBehaviour.cs");
            var expected = VerifyCS.Diagnostic("MIRAGE1101")
                .WithLocation(0)
