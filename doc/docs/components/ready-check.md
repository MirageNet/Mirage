...
{{{ Path:'Snippets/Components/LobbyReadyCheck.cs' Name:'ready-ui' }}}
...
{{{ Path:'Snippets/Components/LobbyReadyCheck.cs' Name:'send-to-ready' }}}
...
{{{ Path:'Snippets/Components/LobbyReadyCheck.cs' Name:'send-to-not-ready' }}}
...
{{{ Path:'Snippets/Components/LobbyReadyCheck.cs' Name:'set-all-not-ready' }}}
