# Mirage Network Profiler

The Mirage Profiler is part of the Mirage Pro suit.
...
1. Make sure you have the latest version of Mirage.
2. Become a [GitHub Sponsor](https://github.com/sponsors/vis2k) if you haven't.
3. Visit with the Mirage Networking Discord. In the _information_ channel you will learn how to join the _github_sponsors_ channel.
...
## Usage
1. In Unity menu, click on Open Window -> Analysis -> Mirage Network Profiler. The profiler view will appear
