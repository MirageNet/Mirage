...
The following sample shows the code that is generated by Mirage for the `SerializeSyncVars` function which is called inside <xref:Mirror.NetworkBehaviour>`.OnSerialize`:
...
The following sample shows the code that is generated by Mirage for the `DeserializeSyncVars` function which is called inside <xref:Mirror.NetworkBehaviour>`.OnDeserialize`:
