...
[Create an issue](https://github.com/MirageNet/Mirror/issues/new?template=bug_report.md) on the project's repository and provide the following information.
...
[Create an issue](https://github.com/MirageNet/Mirror/issues/new?template=feature_request.md) on the project's repository and provide the following information:
...
Please send a [GitHub Pull Request](https://github.com/MirageNet/Mirror/compare) with a clear list of what you've done (read more about [pull requests](http://help.github.com/pull-requests/)). 
