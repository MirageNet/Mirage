...
namespace Mirage.Weaver.SyncVars
{
    ...
    internal class FloatPackerException : SyncVarException
    {
        public FloatPackerException(string message, MemberReference memberReference) : base(message, memberReference) { }
    }
}
