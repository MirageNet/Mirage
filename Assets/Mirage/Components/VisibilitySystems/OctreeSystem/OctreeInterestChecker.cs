...
namespace Mirage.Components
{
    public class OctreeInterestChecker : NetworkBehaviour
    {
        ...
        private OctreeVisibilityInspector _octreeVisibilityInspector;
        ...
        {
            _octreeVisibilityInspector ??= FindObjectOfType<OctreeVisibilityInspector>();
