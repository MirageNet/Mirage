...
namespace Mirage
{
    ...
    public sealed class NetworkIdentity : MonoBehaviour
    {
        ...
        /// <summary>
        ///     Unique id for this object instance on this instance of the server, used to track objects between 2 or more of the same servers running
        ///     to allow splitting of the servers into multiple shards to offload work.
        /// </summary>
        public byte ServerId { get; internal set; }
