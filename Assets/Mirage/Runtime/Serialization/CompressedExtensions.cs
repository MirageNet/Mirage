...
namespace Mirage.Serialization
{
    ...
    {
        [WeaverIgnore]
        public static unsafe void PackRotation(this NetworkWriter writer, Quaternion rotation)
        {
        ...
        [WeaverIgnore]
        public static unsafe Quaternion UnPackRotation(this NetworkReader reader)
        {
