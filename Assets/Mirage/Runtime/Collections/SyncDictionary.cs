...
namespace Mirage.Collections
{
    public class SyncIDictionary<TKey, TValue> : IDictionary<TKey, TValue>, ISyncObject, IReadOnlyDictionary<TKey, TValue>
    {
        ...
        public void OnSerializeDelta(NetworkWriter writer)
        {
            ...
            var fullSync = _changes.Count > 100 && _changes.Count > objects.Count;
        ...
        public void OnDeserializeAll(NetworkReader reader)
        {
            ...
            if (count > MaxElements)
                throw new InvalidOperationException($"SyncDictionary capacity would exceed MaxElements limit of {MaxElements}");
        ...
        private void DeserializeAdd(NetworkReader reader, bool apply)
        {
            ...
            if (apply)
            {
                if (!objects.ContainsKey(key) && objects.Count >= MaxElements)
                    throw new InvalidOperationException($"SyncDictionary capacity would exceed MaxElements limit of {MaxElements}");
