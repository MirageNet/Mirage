...
namespace Mirage.Examples.Additive
{
    ...
    public class ZoneHandler : NetworkBehaviour
    {
        ...
        void OnTriggerEnter(Collider other)
        {
            ...
            networkIdentity.ConnectionToClient.Send(new SceneLoadStartedMessage { MainActivateScene = subScene, SceneOperation = SceneOperation.LoadAdditive });
        }
        ...
        void OnTriggerExit(Collider other)
        {
            ...
            NetworkIdentity networkIdentity = other.gameObject.GetComponent<NetworkIdentity>();
            networkIdentity.ConnectionToClient.Send(new SceneLoadStartedMessage { MainActivateScene = subScene, SceneOperation = SceneOperation.UnloadAdditive });
        }
    }
}
