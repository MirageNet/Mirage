...
namespace Mirage.Snippets.SceneLoading
{
    public class LoadSceneAdditivelyPlayer : MonoBehaviour
    {
        public void Example(NetworkSceneManager sceneManager, INetworkPlayer Player)
        {
            ...
            sceneManager.ServerLoadSceneAdditively("path to scene asset file.", new[] { Player });
        ...
        public void ExampleNormal(NetworkSceneManager sceneManager, INetworkPlayer Player)
        {
            ...
            sceneManager.ServerLoadSceneAdditively("path to scene asset file.", new[] { Player }, true);
        ...
        public void ExamplePhysics(NetworkSceneManager sceneManager, INetworkPlayer Player)
        {
            ...
            sceneManager.ServerLoadSceneAdditively("path to scene asset file.", new[] { Player }, false, new UnityEngine.SceneManagement.LoadSceneParameters { loadSceneMode = UnityEngine.SceneManagement.LoadSceneMode.Additive, localPhysicsMode = UnityEngine.SceneManagement.LocalPhysicsMode.Physics2D });
