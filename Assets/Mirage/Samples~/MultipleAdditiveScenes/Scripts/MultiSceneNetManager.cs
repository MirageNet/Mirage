...
namespace Mirage.Examples.MultipleAdditiveScenes
{
    ...
    public class MultiSceneNetManager : NetworkManager
    {
        ...
        IEnumerator AddPlayerDelayed(INetworkPlayer player)
        {
            ...
            player.Send(new SceneLoadStartedMessage { MainActivateScene = gameScene, SceneOperation = SceneOperation.LoadAdditive });
        ...
        {
            Server.SendToAll(new SceneLoadStartedMessage { MainActivateScene = gameScene, SceneOperation = SceneOperation.UnloadAdditive });
