...
namespace Mirror
{
    ...
    public abstract class NetworkBehaviour : MonoBehaviour
    {
        ...
        #region Client RPCs
        [EditorBrowsable(EditorBrowsableState.Never)]
        internal protected void SendRpcInternal(Type invokeClass, string rpcName, NetworkWriter writer, int channelId, bool excludeOwner)
        {
            // this was in Weaver before
        ...
        [EditorBrowsable(EditorBrowsableState.Never)]
        internal protected void SendTargetRpcInternal(INetworkConnection conn, Type invokeClass, string rpcName, NetworkWriter writer, int channelId)
        {
            // this was in Weaver before
            if (!Server || !Server.Active)
            {
