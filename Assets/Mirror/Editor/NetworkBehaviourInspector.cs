...
namespace Mirror
{
    ...
    public class NetworkBehaviourInspector : Editor
    {
        ...
        private readonly List<string> syncVarNames = new List<string>();
        ...
        protected virtual bool HideScriptField => false;

        // does this type sync anything? otherwise we don't need to show syncInterval
        private static bool SyncsAnything(Type scriptClass)
        {
