...
namespace Mirror.Examples.Additive
{
    ...
    public class ZoneHandler : NetworkBehaviour
    {
        ...
        void OnTriggerEnter(Collider other)
        {
            ...
            NetIdentity.serverObjectManager.SendToClientOfPlayer(networkIdentity, new SceneMessage { sceneName = subScene, sceneOperation = SceneOperation.LoadAdditive });
        }
        ...
        void OnTriggerExit(Collider other)
        {
            ...
            NetworkIdentity networkIdentity = other.gameObject.GetComponent<NetworkIdentity>();
            NetIdentity.serverObjectManager.SendToClientOfPlayer(networkIdentity, new SceneMessage { sceneName = subScene, sceneOperation = SceneOperation.UnloadAdditive });
        }
    }
}
