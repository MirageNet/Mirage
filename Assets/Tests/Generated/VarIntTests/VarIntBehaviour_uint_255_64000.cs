...
namespace Mirage.Tests.Runtime.Generated.VarIntTests.uint_255_64000
{
    ...
    public class BitPackBehaviour : NetworkBehaviour
    {
        ...
        [ClientRpc]
        public void RpcSomeFunction([VarInt(255, 64000)] uint myParam)
        {
    ...
    {
        static uint[] values = new uint[] { 170U, 500U, 15000U, 50000U };
        static int[] expectedBitCounts = new int[] { 9, 18, 18, 18 };
