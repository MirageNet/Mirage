...
namespace Mirage.Tests.Runtime.Generated.VarIntTests.int_100_1000
{
    ...
    public class BitPackBehaviour : NetworkBehaviour
    {
        ...
        [ClientRpc]
        public void RpcSomeFunction([VarInt(100, 1000, 10000)] int myParam)
        {
    ...
    public class BitPackTest : ClientServerSetup<BitPackBehaviour>
    {
        ...
        static TestCase[] cases = new TestCase[] 
        {
            ...
            new TestCase { value = 1000, expectedBits = 12 },
            new TestCase { value = 10000, expectedBits = 16 }
        };
