...
namespace Mirage.Tests.Runtime.Generated.VarIntTests.MyEnumByte_4_64
{
    ...
    public class BitPackTest : ClientServerSetup<BitPackBehaviour>
    {
        ...
        private static TestCase[] cases = new TestCase[] 
        {
            ...
            new TestCase { value = (MyEnumByte)16, expectedBits = 9 },
            new TestCase { value = (MyEnumByte)64, expectedBits = 9 }
        };
