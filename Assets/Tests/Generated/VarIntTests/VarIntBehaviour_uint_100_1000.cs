...
namespace Mirage.Tests.Runtime.Generated.VarIntTests.uint_100_1000
{
    ...
    public class BitPackBehaviour : NetworkBehaviour
    {
        ...
        [ClientRpc]
        public void RpcSomeFunction([VarInt(100, 1000, 10000)] uint myParam)
        {
    ...
    public class BitPackTest : ClientServerSetup<BitPackBehaviour>
    {
        ...
        private static TestCase[] cases = new TestCase[] 
        {
            ...
            new TestCase { value = 1000U, expectedBits = 12 },
