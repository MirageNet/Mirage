...
namespace Mirage.Tests.Runtime.Generated.Vector3PackAttributeTests._100_30b
{
    public class BitPackBehaviour : NetworkBehaviour
    {
        [Vector3Pack(100f, 100f, 100f, 10)]
        [SyncVar] public Vector3 myValue;

        public event Action<Vector3> onRpc;

        [ClientRpc]
        public void RpcSomeFunction([Vector3Pack(100f, 100f, 100f, 10)] Vector3 myParam)
        {
