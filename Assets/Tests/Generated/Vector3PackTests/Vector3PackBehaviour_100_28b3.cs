...
namespace Mirage.Tests.Runtime.Generated.Vector3PackAttributeTests._100_28b3
{
    public class BitPackBehaviour : NetworkBehaviour
    {
        [Vector3Pack(100f, 20f, 100f, 10, 8, 10)]
        [SyncVar] public Vector3 myValue;

        public event Action<Vector3> onRpc;

        [ClientRpc]
        public void RpcSomeFunction([Vector3Pack(100f, 20f, 100f, 10, 8, 10)] Vector3 myParam)
        {
