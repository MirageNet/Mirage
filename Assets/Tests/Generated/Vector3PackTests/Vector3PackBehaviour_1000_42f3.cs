...
namespace Mirage.Tests.Runtime.Generated.Vector3PackAttributeTests._1000_42f3
{
    public class BitPackBehaviour : NetworkBehaviour
    {
        [Vector3Pack(1000f, 200f, 1000f, 0.1f, 0.1f, 0.1f)]
        [SyncVar] public Vector3 myValue;

        public event Action<Vector3> onRpc;

        [ClientRpc]
        public void RpcSomeFunction([Vector3Pack(1000f, 200f, 1000f, 0.1f, 0.1f, 0.1f)] Vector3 myParam)
        {
