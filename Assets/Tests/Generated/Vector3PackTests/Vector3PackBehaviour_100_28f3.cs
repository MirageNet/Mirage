...
namespace Mirage.Tests.Runtime.Generated.Vector3PackAttributeTests._100_28f3
{
    public class BitPackBehaviour : NetworkBehaviour
    {
        [Vector3Pack(100f, 20f, 100f, 0.2f, 0.2f, 0.2f)]
        [SyncVar] public Vector3 myValue;

        public event Action<Vector3> onRpc;

        [ClientRpc]
        public void RpcSomeFunction([Vector3Pack(100f, 20f, 100f, 0.2f, 0.2f, 0.2f)] Vector3 myParam)
        {
