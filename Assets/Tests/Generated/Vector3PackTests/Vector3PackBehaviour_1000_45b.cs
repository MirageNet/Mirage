...
namespace Mirage.Tests.Runtime.Generated.Vector3PackAttributeTests._1000_45b
{
    public class BitPackBehaviour : NetworkBehaviour
    {
        [Vector3Pack(1000f, 200f, 1000f, 15)]
        [SyncVar] public Vector3 myValue;

        public event Action<Vector3> onRpc;

        [ClientRpc]
        public void RpcSomeFunction([Vector3Pack(1000f, 200f, 1000f, 15)] Vector3 myParam)
        {
    ...
    public class BitPackTest : ClientServerSetup<BitPackBehaviour>
    {
        ...
        public IEnumerator RpcIsBitPacked()
        {
            ...
            int expectedPayLoadSize = (45 + 7) / 8;
            Assert.That(payloadSize, Is.EqualTo(expectedPayLoadSize), $"45 bits is %%PAYLOAD_SIZE%% bytes in payload");
        }
        ...
        public IEnumerator StructIsBitPacked() 
        {
            ...
            int expectedPayLoadSize = ((45 + 7) / 8) + 2;
            Assert.That(payloadSize, Is.EqualTo(expectedPayLoadSize), $"45 bits is {expectedPayLoadSize - 2} bytes in payload");
