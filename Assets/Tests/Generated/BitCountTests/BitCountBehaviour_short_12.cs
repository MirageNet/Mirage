...
namespace Mirage.Tests.Runtime.Generated.BitCountAttributeTests.short_12
{
    ...
    public class BitPackTest : ClientServerSetup<BitPackBehaviour>
    {
        ...
        public IEnumerator RpcIsBitPacked()
        {
            ...
            int expectedPayLoadSize = (12 + 7) / 8;
            Assert.That(payloadSize, Is.EqualTo(expectedPayLoadSize), $"12 bits is 2 bytes in payload");
        }
        ...
        public IEnumerator StructIsBitPacked() 
        {
            ...
            int expectedPayLoadSize = ((12 + 7) / 8) + 2;
            Assert.That(payloadSize, Is.EqualTo(expectedPayLoadSize), $"12 bits is {expectedPayLoadSize - 2} bytes in payload");
