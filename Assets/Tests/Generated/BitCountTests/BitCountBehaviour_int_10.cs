...
namespace Mirage.Tests.Runtime.Generated.BitCountAttributeTests.int_10
{
    ...
    public class BitPackTest : ClientServerSetup<BitPackBehaviour>
    {
        ...
        public IEnumerator StructIsBitPacked() 
        {
            ...
            Assert.That(payloadSize, Is.EqualTo(expectedPayLoadSize), $"10 bits is {expectedPayLoadSize} bytes in payload");
