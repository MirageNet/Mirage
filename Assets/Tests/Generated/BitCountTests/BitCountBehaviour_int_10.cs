...
namespace Mirage.Tests.Runtime.Generated.BitCountAttributeTests
{
    ...
    public class BitCountTest_int_10 : ClientServerSetup<BitCountBehaviour_int_10>
    {
        ...
        public void SyncVarIsBitPacked()
        {
            ...
            var server = new GameObject("a", typeof(NetworkIdentity)).AddComponent<BitCountBehaviour_int_10>();
            var client = new GameObject("a", typeof(NetworkIdentity)).AddComponent<BitCountBehaviour_int_10>();
