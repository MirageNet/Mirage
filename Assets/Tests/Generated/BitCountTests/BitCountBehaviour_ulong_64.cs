...
namespace Mirage.Tests.Runtime.Generated.BitCountAttributeTests.ulong_64
{
    ...
    public class BitPackTest : ClientServerSetup<BitPackBehaviour>
    {
        ...
        public IEnumerator RpcIsBitPacked()
        {
            ...
            int expectedPayLoadSize = (64 + 7) / 8;
            Assert.That(payloadSize, Is.EqualTo(expectedPayLoadSize), $"64 bits is 8 bytes in payload");
        }
        ...
        public IEnumerator StructIsBitPacked() 
        {
            ...
            int expectedPayLoadSize = ((64 + 7) / 8) + 2;
            Assert.That(payloadSize, Is.EqualTo(expectedPayLoadSize), $"64 bits is {expectedPayLoadSize - 2} bytes in payload");
