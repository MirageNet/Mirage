...
namespace Mirage.Tests.Runtime.Generated.BitCountAttributeTests
{
    ...
    public class BitCountTest_ulong_64 : ClientServerSetup<BitCountBehaviour_ulong_64>
    {
        ...
        public void SyncVarIsBitPacked()
        {
            ...
            var server = new GameObject("a", typeof(NetworkIdentity)).AddComponent<BitCountBehaviour_ulong_64>();
            var client = new GameObject("a", typeof(NetworkIdentity)).AddComponent<BitCountBehaviour_ulong_64>();
