...
namespace Mirage.Tests.Runtime.Generated.BitCountAttributeTests.int_32
{
    ...
    public class BitPackTest : ClientServerSetup<BitPackBehaviour>
    {
        ...
        public IEnumerator RpcIsBitPacked()
        {
            ...
            Assert.That(payloadSize, Is.EqualTo(expectedPayLoadSize), $"32 bits is 4 bytes in payload");
        }
        ...
        public IEnumerator StructIsBitPacked() 
        {
            ...
            Assert.That(payloadSize, Is.EqualTo(expectedPayLoadSize), $"32 bits is {expectedPayLoadSize} bytes in payload");
