...
namespace Mirage.Tests.Runtime.Generated.BitCountAttributeTests
{
    ...
    public class BitCountTest_int_17 : ClientServerSetup<BitCountBehaviour_int_17>
    {
        ...
        public void SyncVarIsBitPacked()
        {
            ...
            var server = new GameObject("a", typeof(NetworkIdentity)).AddComponent<BitCountBehaviour_int_17>();
            var client = new GameObject("a", typeof(NetworkIdentity)).AddComponent<BitCountBehaviour_int_17>();
