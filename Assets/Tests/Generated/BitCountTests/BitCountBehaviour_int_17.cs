...
namespace Mirage.Tests.Runtime.Generated.BitCountAttributeTests.int_17
{
    ...
    public class BitPackTest : ClientServerSetup<BitPackBehaviour>
    {
        ...
        public IEnumerator RpcIsBitPacked()
        {
            ...
            Assert.That(payloadSize, Is.EqualTo(expectedPayLoadSize), $"17 bits is 3 bytes in payload");
        }
