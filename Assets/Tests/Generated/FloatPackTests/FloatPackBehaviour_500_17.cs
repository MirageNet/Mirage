...
namespace Mirage.Tests.Runtime.Generated.FloatPackAttributeTests._500_17
{
    public class BitPackBehaviour : NetworkBehaviour
    {
        ...
        [ClientRpc]
        public void RpcSomeFunction([FloatPack(500, 0.01f)] float myParam)
        {
    ...
    {
        private const float value = 5.2f;
        private const float within = 0.00763f;
        ...
        public IEnumerator RpcIsBitPacked()
        {
            ...
            int expectedPayLoadSize = (17 + 7) / 8;
            Assert.That(payloadSize, Is.EqualTo(expectedPayLoadSize), $"17 bits is %%PAYLOAD_SIZE%% bytes in payload");
        }
        ...
        public IEnumerator StructIsBitPacked() 
        {
            ...
            int expectedPayLoadSize = ((17 + 7) / 8) + 2;
            Assert.That(payloadSize, Is.EqualTo(expectedPayLoadSize), $"17 bits is {expectedPayLoadSize - 2} bytes in payload");
