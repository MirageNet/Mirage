...
namespace Mirage.Tests.Runtime.Generated.FloatPackAttributeTests._1_8
{
    public class BitPackBehaviour : NetworkBehaviour
    {
        ...
        [ClientRpc]
        public void RpcSomeFunction([FloatPack(1, 8)] float myParam)
        {
    ...
    {
        private const float value = 0.2f;
        private const float within = 0.00785f;
        ...
        public IEnumerator RpcIsBitPacked()
        {
            ...
            int expectedPayLoadSize = (8 + 7) / 8;
            Assert.That(payloadSize, Is.EqualTo(expectedPayLoadSize), $"8 bits is %%PAYLOAD_SIZE%% bytes in payload");
        }
