...
namespace Mirage.Tests.Runtime.Generated.FloatPackAttributeTests._100_14
{
    public class BitPackBehaviour : NetworkBehaviour
    {
        ...
        [ClientRpc]
        public void RpcSomeFunction([FloatPack(100, 0.02f)] float myParam)
        {
    ...
    public class BitPackTest : ClientServerSetup<BitPackBehaviour>
    {
        ...
        private const float within = 0.0123f;
        ...
        public IEnumerator RpcIsBitPacked()
        {
            ...
            int expectedPayLoadSize = (14 + 7) / 8;
            Assert.That(payloadSize, Is.EqualTo(expectedPayLoadSize), $"14 bits is %%PAYLOAD_SIZE%% bytes in payload");
        }
        ...
        public IEnumerator StructIsBitPacked() 
        {
            ...
            int expectedPayLoadSize = ((14 + 7) / 8) + 2;
            Assert.That(payloadSize, Is.EqualTo(expectedPayLoadSize), $"14 bits is {expectedPayLoadSize - 2} bytes in payload");
