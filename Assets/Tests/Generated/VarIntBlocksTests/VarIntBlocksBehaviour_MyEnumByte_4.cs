...
namespace Mirage.Tests.Runtime.Generated.VarIntBlocksTests.MyEnumByte_4
{
    ...
    {
        [VarIntBlocks(4)]
        [SyncVar] public MyEnumByte MyValue { get; set; }

        public event Action<MyEnumByte> onRpc;

        [ClientRpc]
        public void RpcSomeFunction([VarIntBlocks(4)] MyEnumByte myParam)
        {
    ...
    public class BitPackTest : ClientServerSetup<BitPackBehaviour>
    {
        ...
        {
            new TestCase { value = (MyEnumByte)0, expectedBits = 5 },
            new TestCase { value = (MyEnumByte)4, expectedBits = 5 },
            new TestCase { value = (MyEnumByte)16, expectedBits = 10 },
            new TestCase { value = (MyEnumByte)64, expectedBits = 10 }
        };
