...
namespace Mirage.Tests.Runtime.Generated.VarIntBlocksTests.short_6
{
    ...
    public class BitPackBehaviour : NetworkBehaviour
    {
        ...
        [ClientRpc]
        public void RpcSomeFunction([VarIntBlocks(6)] short myParam)
        {
    ...
    public class BitPackTest : ClientServerSetup<BitPackBehaviour>
    {
        ...
        {
            new TestCase { value = (short)10, expectedBits = 7 },
            new TestCase { value = (short)100, expectedBits = 14 },
            new TestCase { value = (short)1000, expectedBits = 14 },
            new TestCase { value = (short)10000, expectedBits = 21 }
        };
