...
namespace Mirage.Tests.Runtime.Generated.BitCountFromRangeAttributeTests
{
    ...
    public class BitCountRangeTest_int_N1000_0 : ClientServerSetup<BitCountRangeBehaviour_int_N1000_0>
    {
        ...
        public void SyncVarIsBitPacked()
        {
            ...
            var server = new GameObject("a", typeof(NetworkIdentity)).AddComponent<BitCountRangeBehaviour_int_N1000_0>();
            var client = new GameObject("a", typeof(NetworkIdentity)).AddComponent<BitCountRangeBehaviour_int_N1000_0>();
