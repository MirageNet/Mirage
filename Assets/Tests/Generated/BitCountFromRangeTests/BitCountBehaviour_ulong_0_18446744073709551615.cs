...
namespace Mirage.Tests.Runtime.Generated.BitCountFromRangeAttributeTests
{
    ...
    public class BitCountRangeBehaviour_ulong_0_18446744073709551615 : NetworkBehaviour
    {
        ...
        [ClientRpc]
        public void RpcSomeFunction([BitCountFromRange(0, 18446744073709551615)] ulong myParam)
        {
            onRpc?.Invoke(myParam);
        }
    }
    public class BitCountRangeTest_ulong_0_18446744073709551615 : ClientServerSetup<BitCountRangeBehaviour_ulong_0_18446744073709551615>
    {
        ...
        public void SyncVarIsBitPacked()
        {
            ...
            var server = new GameObject("a", typeof(NetworkIdentity)).AddComponent<BitCountRangeBehaviour_ulong_0_18446744073709551615>();
            var client = new GameObject("a", typeof(NetworkIdentity)).AddComponent<BitCountRangeBehaviour_ulong_0_18446744073709551615>();
