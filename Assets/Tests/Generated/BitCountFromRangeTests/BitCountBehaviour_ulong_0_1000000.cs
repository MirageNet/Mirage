...
namespace Mirage.Tests.Runtime.Generated.BitCountFromRangeAttributeTests
{
    ...
    public class BitCountRangeBehaviour_ulong_0_1000000 : NetworkBehaviour
    {
        [BitCountFromRange(0, 1000000)]
        [SyncVar] public ulong myValue;

        public event Action<ulong> onRpc;

        [ClientRpc]
        public void RpcSomeFunction([BitCountFromRange(0, 1000000)] ulong myParam)
        {
            onRpc?.Invoke(myParam);
        }
    }
    public class BitCountRangeTest_ulong_0_1000000 : ClientServerSetup<BitCountRangeBehaviour_ulong_0_1000000>
    {
        ...
        public void SyncVarIsBitPacked()
        {
            ...
            var server = new GameObject("a", typeof(NetworkIdentity)).AddComponent<BitCountRangeBehaviour_ulong_0_1000000>();
            var client = new GameObject("a", typeof(NetworkIdentity)).AddComponent<BitCountRangeBehaviour_ulong_0_1000000>();
        ...
        public IEnumerator RpcIsBitPacked()
        {
            ...
            Assert.That(payloadSize, Is.EqualTo(3), $"%%BIT_COUNT%% bits is 3 bytes in payload");
        }
    }
}
