...
namespace Mirage.Tests.Runtime.Generated.BitCountFromRangeAttributeTests
{
    ...
    public class BitCountRangeBehaviour_int_N20000_20000 : NetworkBehaviour
    {
        [BitCountFromRange(-20000, 20000)]
        [SyncVar] public int myValue;

        public event Action<int> onRpc;

        [ClientRpc]
        public void RpcSomeFunction([BitCountFromRange(-20000, 20000)] int myParam)
        {
            onRpc?.Invoke(myParam);
        }
    }
    public class BitCountRangeTest_int_N20000_20000 : ClientServerSetup<BitCountRangeBehaviour_int_N20000_20000>
    {
        const int value = 20;
        ...
        public void SyncVarIsBitPacked()
        {
            ...
            var server = new GameObject("a", typeof(NetworkIdentity)).AddComponent<BitCountRangeBehaviour_int_N20000_20000>();
            var client = new GameObject("a", typeof(NetworkIdentity)).AddComponent<BitCountRangeBehaviour_int_N20000_20000>();
