...
namespace Mirage.Tests.Runtime.Generated.BitCountFromRangeAttributeTests
{
    ...
    public class BitCountRangeBehaviour_short_N1000_1000 : NetworkBehaviour
    {
        ...
        [ClientRpc]
        public void RpcSomeFunction([BitCountFromRange(-1000, 1000)] short myParam)
        {
    ...
    public class BitCountRangeTest_short_N1000_1000 : ClientServerSetup<BitCountRangeBehaviour_short_N1000_1000>
    {
        ...
        public void SyncVarIsBitPacked()
        {
            ...
            var server = new GameObject("a", typeof(NetworkIdentity)).AddComponent<BitCountRangeBehaviour_short_N1000_1000>();
            var client = new GameObject("a", typeof(NetworkIdentity)).AddComponent<BitCountRangeBehaviour_short_N1000_1000>();
