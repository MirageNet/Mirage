...
namespace Mirage.Tests.Runtime.Generated.Vector2PackAttributeTests._200_26f2
{
    public class BitPackBehaviour : NetworkBehaviour
    {
        [Vector2Pack(200f, 200f, 0.05f, 0.05f)]
        [SyncVar] public Vector2 MyValue { get; set; }

        public event Action<Vector2> onRpc;

        [ClientRpc]
        public void RpcSomeFunction( [Vector2Pack(200f, 200f, 0.05f, 0.05f)] Vector2 myParam)
        {
