...
namespace Mirage.Tests.Runtime.Generated.Vector2PackAttributeTests._200_26b2
{
    public class BitPackBehaviour : NetworkBehaviour
    {
        [Vector2Pack(200f, 200f, 13, 13)]
        [SyncVar] public Vector2 MyValue { get; set; }

        public event Action<Vector2> onRpc;

        [ClientRpc]
        public void RpcSomeFunction( [Vector2Pack(200f, 200f, 13, 13)] Vector2 myParam)
        {
