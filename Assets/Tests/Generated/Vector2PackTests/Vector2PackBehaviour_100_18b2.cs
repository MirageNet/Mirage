...
namespace Mirage.Tests.Runtime.Generated.Vector2PackAttributeTests._100_18b2
{
    public class BitPackBehaviour : NetworkBehaviour
    {
        [Vector2Pack(100f, 20f, 10, 8)]
        [SyncVar] public Vector2 MyValue { get; set; }

        public event Action<Vector2> onRpc;

        [ClientRpc]
        public void RpcSomeFunction( [Vector2Pack(100f, 20f, 10, 8)] Vector2 myParam)
        {
