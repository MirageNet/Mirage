...
namespace Mirage.Tests.Runtime.Generated.Vector2PackAttributeTests._1000_27f2
{
    public class BitPackBehaviour : NetworkBehaviour
    {
        [Vector2Pack(1000f, 200f, 0.1f, 0.1f)]
        [SyncVar] public Vector2 MyValue { get; set; }

        public event Action<Vector2> onRpc;

        [ClientRpc]
        public void RpcSomeFunction( [Vector2Pack(1000f, 200f, 0.1f, 0.1f)] Vector2 myParam)
        {
    ...
    public class BitPackTest : ClientServerSetup<BitPackBehaviour>
    {
        ...
        public IEnumerator RpcIsBitPacked()
        {
            ...
            int expectedPayLoadSize = (27 + 7) / 8;
            Assert.That(payloadSize, Is.EqualTo(expectedPayLoadSize), $"27 bits is %%PAYLOAD_SIZE%% bytes in payload");
        }
        ...
        public IEnumerator StructIsBitPacked() 
        {
            ...
            int expectedPayLoadSize = ((27 + 7) / 8) + 2;
            Assert.That(payloadSize, Is.EqualTo(expectedPayLoadSize), $"27 bits is {expectedPayLoadSize - 2} bytes in payload");
