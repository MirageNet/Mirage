...
namespace Mirage.Tests.CodeGenerators
{
    public static class Vector3PackTestGenerator
    {
        ...
        public static void CreateAll()
        {
            ...
            Create(fromTemplate, "100_30f", new Vector3(100, 100, 100), "10", new Vector3(-10.3f, 0.2f, 20), 0.2f, 30);
            ...
            Create(fromTemplate, "1000_45f", new Vector3(1000, 200, 1000), "15", new Vector3(10.3f, 0.2f, 20), 0.2f, 45);
            ...
            Create(fromTemplate, "200_39f", new Vector3(200, 200, 200), "13", new Vector3(10.3f, 0.2f, 20), 0.2f, 39);
